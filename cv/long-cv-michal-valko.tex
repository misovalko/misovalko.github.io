...
\citembullet
Yunhao Tang, Taco Cohen, David W. Zhang, {\bf Michal Valko}, Rémi Munos:
 \href{https://arxiv.org/pdf/2503.19612}{\emph{RL-finetuning LLMs from on- and off-policy data with a single algorithm}},
({\sf preprint}) 
...
\begin{category}{Papers\\2025}
\citembullet
C\^ome Fiegel, Pierre M\' enard, Tadashi Kozuno,   {\bf Michal Valko}, Vianney Perchet:
\emph{The Harder Path: Last iterate convergence for uncoupled Learning in zero-sum games with bandit feedback},
...
\begin{category}{Invited Talks}
	 ...
	 \citembullet
	 \emph{GenerationAI}, 
         Dec 9-10, 2025, Paris, France,
	 ({\sf  APIdays 2025)	}


	 \citembullet
	\emph{The OECD conference on AI}, 
         November 24-26, 2025, Europe
	 ({\sf OECD 2025}) 

	\citembullet
	\emph{Sword AI Summit}
         Nov  15, 2025,  Porto, Portugal
	({\sf   Sword  2025})	

	 \citembullet
	\emph{The dot AI}, 
         November 13, 2025, Europe
	 ({\sf DOT 2025}) 


	 \citembullet
	\emph{The change for education is here!}, 
         October 11,  2025, Europe
	 ({\sf Change 2025}) 
	...
	\citembullet
	\emph{AI Innovations}, 
         September 17--18, 2025, Kosice, Slovakia 
	 ({\sf SlovakiaTech 2025})	 

	\citembullet
	\emph{Powerful LLM alignment} (keynote),
         Sep 12--13, 2025, Yerevan, Armenia
	 ({\sf DataFest 2025})

	 \citembullet
	\emph{Deutsche Telkom Conference}, 
         September 9, 2025, Europe
	 ({\sf Telkom 2025}) 

	 \citembullet
	\emph{Festival Atmosf\'era}, 
         August 2nd, 2025, Hontianske Nemce, Slovakia 
	 ({\sf Atmosf\'era 2025}) 
	
	\citembullet
	\emph{Maths of LLMs (mini-course)}, 
         June 29 – July 6, 2025, Tsaghkadzor, Armenia 
	 ({\sf MSS 2025})	  

	\citembullet
	\emph{Next generation of language models}, 
          June 2025, Bratislava, Slovakia 
	 ({\sf ESSAI 2025})	
	 
	
	 \citembullet
	\emph{Carrefour de l'innovation}, 
         June 26, 2025, Europe
	 ({\sf France Diplomatie 2025})
	
	
	 \citembullet
	\emph{Globsec conference}, 
         June 12-14, 2025, Prague, Czech Republic
	 ({\sf GLOBSEC 2025})
	...
	\emph{World AI Conference Day}, 
	 ...
	 \citembullet
	\emph{firstminute capital Summit}, 
         June 9, 2025, London, UK 
	 ({\sf firstminute 2025}) 

	 \citembullet
	\emph{Orange Tech Conference}, 
         June 5, 2025, Europe
	 ({\sf Orange 2025}) 

	 \citembullet
	\emph{KPMG Leadership Coference}, 
         June 1st, 2025, San Francisco, California
	 ({\sf KPMG 2025}) 


	 \citembullet
	\emph{Innovations United: Startup Disrupt}, 
        June 3rd, 2025, Prague, Czech Republic 
	 ({\sf United 2025}) 

	 \citembullet
	\emph{Forbes Business Fest},
        May 29th, 2025 
	 ({\sf Forbes 2025}) 

	 \citembullet
	\emph{TechWolf AI Day}
        May 27th, 2025, Ghent, Belgium
	 ({\sf TechWolf 2025}) 
	 

	 
	 \citembullet
	\emph{Reflect Festival - The Doers!}
        May 15-16th, 2025, Limasol, Cyprus 
	 ({\sf Reflect 2025}) 
	 ...
	 ({\sf GHOST 2025})	
	 	 ...
	 	 \citembullet
 	\emph{Slovak Oxford Science conference},
         May 1-4, 2025
	 ({\sf SOS	 2025})	


	  \citembullet
 	\emph{Foundation Models for Science}, April 30--May 2, 2025, NYC
  	 ({\sf FLATIRON 2025})	  	
	...
	\citembullet
	\emph{Uncertainty in LLMs}, (keynote)
         April 5-6 2025, Abu Dhabi, UAE
	 ({\sf ATML 2025})	  		 
	...
	\emph{Enterprise AI Summit Europe}, 
	 ...
	 ({\sf EAI 2025})	 	 
	\citembullet
	\emph{DeepMind \& Beyond: Czech and Slovak Scientists at the AI Frontier},
	 February 26, 2025, Prague, Czech Republic
	 ({\sf Kaya 2025})
	\citembullet 	 	 	 	
...
\end{category} \begin{category}{Invited  2024}	 
	...
	\emph{Uncertainty in LLM alignment}, 
	 ...
	 ({\sf GenU 2024})	 		 	 	 
	%\citembullet
	%\emph{Contrastive and non-contrastive LLM alignment} (invited talk),
        %August 9-12, 2024, Amherst, Massachusetts 
	 %({\sf RLC 2024})	 	 	 
	\citembullet
...
\end{category} \begin{category}{Invited  2023}	 		 
	\citembullet
...
\end{category} \begin{category}{Invited  2022}	 	 
...
\end{category} \begin{category}{Invited  2021}	 
\citembullet
...
\end{category} \begin{category}{Invited  2020}	 
\citembullet
\emph{Bootstrap Your Own Latent: A new approach to self-supervised learning}, 
...
\end{category} \begin{category}{Invited  2019}	 
\citembullet
...
\end{category} \begin{category}{Invited  <2018}	 
\citembullet
...
\citembullet AI Refresher -  by Dominik Vetrák ({\sf September 2025}) 
\citembullet Interesections: Talkshow on AI -  moderated by Ivan Jezik ({\sf October 2025}) 
\citembullet Forbes Cover: Slovak AInstein Valko: I want to use AI to alleviate the suffering around us  ({\sf March 2025}) 
\citembullet He worked for Zuckerberg, now he’s launching his own startup: Slovak Michal is a top expert in the field of AI  -- StartItUp ({\sf February 2025}) 
\citembullet The AI Book -- Ringier  ({\sf February 2025}) 
 \citembullet DeepSeek, what's going on? -- Forbes ({\sf February 2025}) 
 \citembullet  Tronche de Tech podcast ({\sf January 2025}) 
 \citembullet Farewell, Mark Zuckerberg. Slovak Michal Valko has left Meta, starting his own business  -- Forbes ({\sf January 2025}) 
\citembullet Famous Slovaks Abroad -- Book ({\sf December 2024}) 
...
\citembullet
Michal Valko starting at Meta, GenAI on Llama team  ({\sf  2024}) 
\begin{itemize}
