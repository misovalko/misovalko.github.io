...
%\href{https://arxiv.org/pdf/XXXXX}{\emph{Adapting to game trees in zero-sum imperfect information games}},
%({\sf preprint}) 
...
\begin{category}{Invited Talks}
	\citembullet
	\emph{Learning by boostrapping: Represention and Reinforcement Learning}, 
	...
	\emph{Learning by boostrapping}, 
	 ...
	 ({\sf ESET 2022})
	\citembullet
	\emph{Learning by boostrapping} (keynote), 
