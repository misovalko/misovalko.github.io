...
\href{https://openreview.net/pdf?id=0q0REJNgtg}
...
\href{https://openreview.net/pdf?id=vRSY3L4Rlhp}{\emph{Density-based bonuses on learned representations for reward-free exploration in deep reinforcement learning}},
({\sf preprint}) 
...
\emph{Marginalized operators for off-policy reinforcement learning},
International Conference on Artificial Intelligence and Statistics
({\sf AISTATS 2022}) 
\end{category}
...
\citembullet
\emph{Reinforcement learning (lecture)}, 
